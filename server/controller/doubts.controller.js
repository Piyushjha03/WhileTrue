...
export const queryController = async (req, res) => {
  try {
    ...
    if (videoID === null || videoID === undefined) {
      ...
      vDetails = await getChapter(videoID);
      t = vDetails.transcript;
    }

    const systemPrompt = `You are a helpful and knowledgeable assistant for an educational platform. You will assist students by answering questions specifically related to the content of the video they have just watched. Here is the transcript of the video: ${t}. Please ensure that your responses are directly relevant to the video's transcript.`;
